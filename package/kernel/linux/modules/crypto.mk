...
define KernelPackage/crypto-deflate
  ...
  DEPENDS:=+kmod-lib-zlib-inflate +kmod-lib-zlib-deflate +(LINUX_4_14||LINUX_4_19):kmod-crypto-acompress
...
define KernelPackage/crypto-hw-ccp
  ...
  DEPENDS:=+kmod-crypto-authenc +kmod-crypto-hash +kmod-crypto-manager +kmod-random-core +kmod-crypto-sha1 +kmod-crypto-sha256 +(LINUX_4_14||LINUX_4_19):kmod-crypto-rsa
  KCONFIG:= \
	CONFIG_CRYPTO_HW=y \
