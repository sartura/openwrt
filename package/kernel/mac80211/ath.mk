...
define KernelPackage/ath11k
  ...
  DEPENDS+=@LINUX_5_10 +@DRIVER_11N_SUPPORT +@DRIVER_11AC_SUPPORT +@DRIVER_11AX_SUPPORT \
  +kmod-ath +kmod-crypto-michael-mic +kmod-qcom-qmi-helpers +ATH11K_THERMAL:kmod-hwmon-core \
